...
const emailConfg = require('../email');
...
//Data is Obj taking in 
//action:It is document mail action
//preheding:It is preheading for our template
//heading:It is head of
...
//                           <a href="
//                                 ${data.url}
//                           " target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">${data.action}</a>
//                         </td>
//                       </tr>
//                     </table>
//                   </td>
...
//               <p style="margin: 0;">Regards,<br>Team Poster</p>
//             </td>
//           </tr>
//           <!-- end copy -->
